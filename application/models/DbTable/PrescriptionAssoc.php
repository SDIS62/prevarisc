<?php
    ...
    class Model_DbTable_PrescriptionAssoc extends Zend_Db_Table_Abstract
    {
        protected $_name="prescriptionassoc"; // Nom de la base
        protected $_primary = "ID_PRESCRIPTIONASSOC"; // Clé primaire
